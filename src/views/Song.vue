  ...
  <main>
    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        <!-- Play/Pause Button -->
        <button class="z-50 h-24 w-24 text-3xl bg-white text-black rounded-full
        focus:outline-none" type="button" @click.prevent="newSong(song)">
        ...
        <div class="z-50 text-left ml-8">
          ...
          <div>{{ song.genre }}</div>
          <div class="song-price">{{ $n(150, 'currency', 'ja')}}</div>
        </div>
      </div>
    </section>
    <!-- Form -->
    <section id="comments" class="container mx-auto mt-6">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          <div v-if="comment_show_alert" :class="comment_alert_variant"
    ...
    <ul class="container mx-auto">
      <li v-for="comment in sortedComments"
          :key="comment.docID" class="p-6 bg-gray-50 border border-gray-200">
        <!-- Comment Author -->
        <div class="mb-5">
